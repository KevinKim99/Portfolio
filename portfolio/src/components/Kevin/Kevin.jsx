  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>I am 4th year UBC student, interested in pursuing a career as a software engieer with a focus on full-stack or front-end developer. My goal is to make a meaningful impact in the software field!</p>
